...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    ArrayList<OrdineBean> olist = odao.doRetrieveAll();
    %>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="card">
      ...
      <table>
        ...
        <tr>
          ...
          <td><%=o.getStato() %></td>
          <td><form action="UpdateOrderServlet?id=<%=o.getNumero()%>" method="post">
      ...
      <table>
    	<tr>
    	<th>
    	<form action="FiltraOrdiniServlet?action=email" method="post">
    	<input name="email" type="text" placeholder="email">
     <input type= "submit" value="Ordina per utente">
     </form>
     </th>
     <th>  </th></tr>
     ...
     <input name="date1" type="date" placeholder="email">
     <input name="date2" type="date" placeholder="email">
